...
This game uses the FS3 system, Third Edition, with Trashcan's Difficult Dice (TDD) sat on top. 
...
For a list of specific abilities available on the game, you can use the `abilities` command or the web portal abilities page (Under System -> Abilities List).

> **Tip:** See [Join Us](https://redplanetmu.com/wiki/guide:join_us) and click the Abilities tab for details about the ratings, costs, and how to choose abilities.
...
The basic roll mechanic in FS3 is to roll a number of dice equal to Attribute + Ability, and count successes.  One success is enough to accomplish the task at hand; more successes mean you do better than expected.
    ...
    <FS3> Hannah rolls Firearms: Good Success (9 9 10 4)
...
You can also do opposed rolls, which basically just compare the number of successes from each side and figure out who won and by how much.
    ...
    <FS3> Flare rolls Firearms (9 4 3 2 1) vs Ivan's Firearms (10 9 9 9 9 5 5 2 1 1)
...
> **Tip:** See the [Luck](https://redplanetmu.com/wiki/system:luck_points) section of the player's guide for details about when and how to use luck points.

Luck is awarded for participation in scenes.  You get a fraction of a luck point for each participant.  There are bonuses for RPing with someone for the first time, and for RPing with a new player, as well as for RPing in Open Scenes. Admins can also issue luck as rewards.
...
> **Tip:** See the [Experience](https://redplanetmu.com/wiki/system:xp) section of the player's guide for details about how to use experience points.

Each XP you spend toward a skill progresses you further towards the next rating.  There is no cooldown between XP spends of the same ability, but there is a limit on the amount of XP you can store up. You can see your progression in all abilities on the "Experience" tab of your web portal character profile, or the `xp` command.
