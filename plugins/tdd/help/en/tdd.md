...
* **Botches and Critical Successes**: With TDD, any roll has a 3% chance of producing a 'Botch' (fails so badly that it produces the opposite intended outcome) and a 3% chance of producing a 'Critical Success' (succeeds spectactularly and against all odds). This introduces an element of risk for very highly ranked skill rolls and an element of hope for very low ones.