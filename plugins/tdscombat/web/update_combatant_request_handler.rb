  ...
  module TDSCombat
    class UpdateCombatantRequestHandler
      def handle(request)
        ...
        can_manage = TDSCombat.can_manage_combat?(enactor, combat)
        ...
        error = TDSCombat.update_combatant(combat, combatant, enactor, team, stance, weapon, selected_weapon_specials, armor, selected_armor_specials, npc_level, action, action_args, vehicle, passenger_type)
