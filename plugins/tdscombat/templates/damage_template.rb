  ...
  module TDSCombat
    class DamageTemplate < ErbTemplateRenderer
      ...
      def severity(d)
        ...
        current_sev = TDSCombat.display_severity(d.current_severity)
      ...
      def healing(d)
        total = TDSCombat.healing_points(d.current_severity)
      ...
      def wound_mod
        TDSCombat.total_damage_mod(target)
      end
      ...
      def vehicle_notice
        ...
        vehicle ? t('tdscombat.vehicle_damage_notice', :name => vehicle.name) : nil
      end
    end
  end
end
