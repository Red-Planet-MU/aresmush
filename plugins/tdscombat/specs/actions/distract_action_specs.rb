    ...
    describe DistractAction do
      ...
      describe :resolve do
        ...
        it "should distract successfully" do
          ...
          expect(TDSCombat).to receive(:roll_attack).with(@combatant, @target1) { 3 }
          ...
          expect(resolutions).to eq [ "tdscombat.distract_successful_msg" ]
        end
        ...
        it "should distract unsuccessfully" do
          ...
          resolutions = @action.resolve
          expect(resolutions).to eq [ "tdscombat.distract_failed_msg" ]
        end
      end
    end
  end
